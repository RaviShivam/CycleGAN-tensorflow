...
parser.add_argument('--crop_size', dest='crop_size', type=int, default=150, help='size of cropped objects')
parser.add_argument('--batch_size', dest='batch_size', type=int, default=1, help='# images in batch')
parser.add_argument('--train_size', dest='train_size', type=int, default=1e8, help='# images used to train')
parser.add_argument('--image_size', dest='image_size', type=int, default=400, help='standard image size which will be predicted')
